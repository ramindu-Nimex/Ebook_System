...
<body style="background-color: #f7f7f7;">
	...
	<div class="container-flued back-img">
				...
				<div class="card crd-ho">
					<div class="card-body text-center">
						...
						if(b.getBookCategory().equals("Old")) {
							...
							<a
								href="viewBook.jsp?bid=<%= b.getBookId() %>" class="btn btn-success btn-sm ml-6">View Details</a> <a
						...
						<div class="row text-center">
							<a href="" class="btn btn-danger btn-sm ml-3">Add Cart</a> <a
								href="viewBook.jsp?bid=<%= b.getBookId() %>" class="btn btn-success btn-sm ml-1">View Details</a> <a
								href="" class="btn btn-danger btn-sm ml-1"><%=b.getPrice()%><i class="fas fa-rupee-sign"></i></a>
						</div>
							<% 
						}
